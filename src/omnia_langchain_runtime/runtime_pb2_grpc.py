...
class RuntimeServiceStub:
    ...
    def __init__(self, channel):
        ...
        self.Converse = channel.stream_stream(
                ...
                response_deserializer=runtime__pb2.ServerMessage.FromString,
...
def add_RuntimeServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Converse': grpc.stream_stream_rpc_method_handler(
                    ...
                    response_serializer=runtime__pb2.ServerMessage.SerializeToString,
            ),
    ...
    server.add_registered_method_handlers('omnia.runtime.v1.RuntimeService', rpc_method_handlers)
...
class RuntimeService:
    ...
    def Converse(request_iterator,
        ...
        return grpc.experimental.stream_stream(
            ...
            runtime__pb2.ServerMessage.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
